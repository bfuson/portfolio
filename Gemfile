...
ruby '2.6.1'
   # the version of Ruby required for this application.
...
gem 'devcamp_view_tool', git: 'https://github.com/bfuson/devcamp_view_tool'
  # the use of git: '......'  shows that the gem is only on github, 
  # it has not been registered to rubygems.org.  It is private
